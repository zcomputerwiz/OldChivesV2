...
from replaceme.util.config import PEER_DB_PATH_KEY_DEPRECATED
...
from replaceme.util.db_version import lookup_db_version
...
class FullNode:
    ...
    def set_server(self, server: ReplacemeServer):
        ...
        if "dns_servers" in self.config:
            ...
            dns_servers.append("dns-introducer.replaceme.net")
        try:
